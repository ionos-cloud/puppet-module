...
Puppet::Type.type(:pcc).provide(:v1) do
  ...
  def self.instances
    ...
    pccs = []
    Ionoscloud::PrivateCrossConnectsApi.new.pccs_get(depth: 1).items.each do |pcc|
  ...
  def description=(value)
    ...
    _, _, headers = Ionoscloud::PrivateCrossConnectsApi.new.pccs_patch_with_http_info(@property_hash[:id], description: value)
  ...
  def create
    ...
    pcc, _, headers = Ionoscloud::PrivateCrossConnectsApi.new.pccs_post_with_http_info(pcc)
    PuppetX::IonoscloudX::Helper.wait_request(headers)
  ...
  def destroy
    ...
    _, _, headers = Ionoscloud::PrivateCrossConnectsApi.new.pccs_delete_with_http_info(@property_hash[:id])
    PuppetX::IonoscloudX::Helper.wait_request(headers)
