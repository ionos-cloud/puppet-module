...
Puppet::Type.type(:snapshot).provide(:v1) do
  ...
  def self.instances
    snapshots = []
    PuppetX::IonoscloudX::Helper.snapshot_api.snapshots_get(depth: 1).items.each do |snapshot|
  ...
  def restore=(_value)
    ...
    _, _, headers = PuppetX::IonoscloudX::Helper.volume_api.datacenters_volumes_restore_snapshot_post_with_http_info(
  ...
  def create
    ...
    snapshot, _, headers = PuppetX::IonoscloudX::Helper.volume_api.datacenters_volumes_create_snapshot_post_with_http_info(
      datacenter_id,
      volume_id,
      {
        name: resource[:name],
  ...
  def flush
    ...
    _, _, headers = PuppetX::IonoscloudX::Helper.snapshot_api.snapshots_patch_with_http_info(@property_hash[:id], changes)
  ...
  def destroy
    ...
    _, _, headers = PuppetX::IonoscloudX::Helper.snapshot_api.snapshots_delete_with_http_info(@property_hash[:id])
    PuppetX::IonoscloudX::Helper.wait_request(headers)
